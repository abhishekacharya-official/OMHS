...
public class hRegMail {
	...
	public void createEmailMessage(String toEmails,String huname, int randomInt) throws AddressException,
		...
		String emailSubject = "Hospital email Comfirmation code for OMHS";
                String url="http://localhost:8080/OMHS_V4/hospEmailCnfrm.jsp?var="+huname+"&key="+uuidi;
