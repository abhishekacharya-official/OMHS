...
public class userFemail {
	...
	public void createEmailMessage(String toEmails,String puname, int randomInt) throws AddressException,
		...
		String emailSubject = "Comfirmation code for OMHS";
                String url="http://localhost:8080/OMHS_v_2/userFpassReq.jsp?var="+puname+"&key="+uuidi;
		String emailBody = "Code for forgot password for patient: "+randomInt;
                emailBody+="\n";
                emailBody+="Link: ";
                emailBody+=url;
