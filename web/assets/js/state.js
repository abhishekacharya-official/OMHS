...
$(function() {
  var options = '';
      options += '<option value="" disabled selected>Select State</option>';
...
function selct_district($val)
{
 ...
 if($val=='Andhra Pradesh') {
  ...
  if ($val=='Odisha') {
    var odisha = ["Angul","Baleshwar","Bargarh","Bhadrak","Bolangir","Bhubaneswar","Cuttack","Debagarh","Dhenkanal","Gajapati","Ganjam","Gopalpur","Jagatsinghpur","Jajpur","Jeypore","Jharsuguda","Kalahandi","Kandhamal","Kendrapada","Kendujhar","Khordha","Koraput","Kosala","Malkangiri","Mayurbhanj","Nabarangpur","Nayagarh","Nuapada","Paradip","Puri","Rayagada","Rourkela","Sambalpur","Subarnapur","Sundergarh","Sarang"];
   $(function() {
  var options = '';
  options += '<option value="" disabled selected>Select City</option>';
